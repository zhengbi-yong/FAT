...
import basicsr.archs.liif_models_arch
from basicsr.utils.registry import ARCH_REGISTRY
from basicsr.archs.liif_util import make_coord
...
class MetaSR(nn.Module):
    ...
    def __init__(self, encoder_spec):
        ...
        self.encoder = basicsr.archs.liif_models_arch.make(encoder_spec)
        imnet_spec = {
            'name': 'mlp',
            'args': {
                'in_dim': 3,
        ...
        self.imnet = basicsr.archs.liif_models_arch.make(imnet_spec)
